...
class _SignUpState extends State<SignUp> {
  ...
  Future signUp() async {
    if (passwordconfirm()) {
      await FirebaseAuth.instance.createUserWithEmailAndPassword(
          ...
          addUsersDetails(firstname.text.trim(),email.text.trim());
  ...
  Future addUsersDetails(String first,String email) async {
    await FirebaseFirestore.instance.collection('color').add({
      'color1': first,
      'email':email,
      'rule':'user',
